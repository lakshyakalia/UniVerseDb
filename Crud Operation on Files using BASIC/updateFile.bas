Declare Function updateFileOperation As Integer

public function updateFileOperation() As Integer
...
dim str1 as String
dim str2 as String
Input "Enter the string you want to update : " , str1
Input "Enter new String : ", str2
